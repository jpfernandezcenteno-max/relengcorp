...
$empresa     = val('empresa');
$pais        = is_string($_POST['pais'] ?? null) ? val('pais') : '';
$solucion_interes = is_string($_POST['solucion_interes'] ?? null) ? val('solucion_interes') : '';
$area_interes = is_string($_POST['area_interes'] ?? null) ? val('area_interes') : '';
$ciudad_pais = is_string($_POST['ciudad_pais'] ?? null) ? val('ciudad_pais') : '';
$mensaje     = val('mensaje');
